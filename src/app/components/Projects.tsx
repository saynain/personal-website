...
export default function Projects() {
  ...
  const ProjectCard = ({ project, index }: { project: Project; index: number }) => (
    <div 
      className={`bg-gradient-to-br from-gray-800 to-slate-800 p-6 rounded-xl border border-pink-400/20 
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="text-center mt-16">
          ...
          <a 
            ...
            target="_blank" 
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 bg-gradient-to-r from-pink-500 to-purple-600 px-6 py-3 rounded-lg font-semibold hover:shadow-lg hover:shadow-pink-500/25 transition-all duration-300 transform hover:scale-105"
          >
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
