      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            <h3 className="text-2xl font-bold mb-6 text-gray-900 dark:text-white">
              Engineer • Developer • Blockchain Enthusiast
            </h3>
        ...
        <div className="mt-16 grid md:grid-cols-3 gap-8">
          <div className="text-center bg-gray-100/50 dark:bg-slate-800/50 rounded-lg p-6 border border-purple-500/20">
            ...
            <h4 className="text-lg font-bold text-gray-900 dark:text-white mb-2">Innovation First</h4>
          ...
          <div className="text-center bg-gray-100/50 dark:bg-slate-800/50 rounded-lg p-6 border border-pink-500/20">
            <div className="text-3xl mb-4">🔗</div>
            <h4 className="text-lg font-bold text-gray-900 dark:text-white mb-2">Blockchain Native</h4>
            <p className="text-gray-600 dark:text-gray-400 text-sm">
              Deep understanding of decentralized systems, smart contracts, and DeFi protocols.
            </p>
          </div>
          
          <div className="text-center bg-gray-100/50 dark:bg-slate-800/50 rounded-lg p-6 border border-yellow-500/20">
            <div className="text-3xl mb-4">⚡</div>
            <h4 className="text-lg font-bold text-gray-900 dark:text-white mb-2">Performance Focused</h4>
            <p className="text-gray-600 dark:text-gray-400 text-sm">
